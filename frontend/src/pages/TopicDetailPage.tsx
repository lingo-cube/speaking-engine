            ...
            >
              ...
              <div className="flex items-center justify-between gap-3 flex-wrap">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary text-white text-sm font-bold hover:bg-primary-hover transition-all duration-200 active:scale-95 cursor-pointer shadow-md shadow-primary/20 flex-shrink-0"
                >
                  Start
